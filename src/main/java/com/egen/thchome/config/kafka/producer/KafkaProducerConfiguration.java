package com.egen.thchome.config.kafka.producer;
...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, CustomerOrder> producerFactoryJson() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, CustomerOrder> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, CustomerOrder> kafkaTemplateJson() throws UnknownHostException {
