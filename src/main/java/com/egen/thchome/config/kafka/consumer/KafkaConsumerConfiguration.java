package com.egen.thchome.config.kafka.consumer;
...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CustomerOrder> jsonKafkaListenerContainerFactory(){
    ...
    public DefaultKafkaConsumerFactory jsonConsumerFactory(){
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(CustomerOrder.class)
        );
    }
